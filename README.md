...
3. Create new forms by clicking the plus button on the bottom of the screen.
...
6. Use the send button to share the form via Facebook. Use the link after loggin out. To fill the form.
